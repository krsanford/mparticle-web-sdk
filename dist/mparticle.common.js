...
} var d, e, f = !0, g = !1; return { s: function s() { d = a[Symbol.iterator](); }, n: function n() { var a = d.next(); return f = a.done, a; }, e: function e(a) { g = !0, e = a; }, f: function f() { try {
...
var BatchUploader = /*#__PURE__*/ function () {
    ...
    return createClass(a, [{ key: "addEventListeners", value: function addEventListeners() { var a = this; window.onbeforeunload = function () { a.prepareAndUpload(!1, a.isBeaconAvailable()); }, window.onpagehide = function () { a.prepareAndUpload(!1, a.isBeaconAvailable()); }; } }, { key: "isBeaconAvailable", value: function isBeaconAvailable() { return !!navigator.sendBeacon; } }, { key: "queueEvent", value: function queueEvent(a) { a && (this.pendingEvents.push(a), this.mpInstance.Logger.verbose("Queuing event: ".concat(JSON.stringify(a))), this.mpInstance.Logger.verbose("Queued event count: ".concat(this.pendingEvents.length)), (!this.batchingEnabled || Types.TriggerUploadType[a.EventDataType]) && this.prepareAndUpload(!1, !1)); } /**
